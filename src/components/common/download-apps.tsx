...
console.log(visibleBanner.image);
  ...
  return (
    // <div className={cn('bg-fill-two overflow-hidden', className)}>
    // <div className={cn('relative bg-fill-two overflow-hidden h-[400px] bg-cover bg-center bg-no-repeat', className)}   style={{ backgroundImage: `url('${visibleBanner?.image}' || '/app-thumbnail.png'})` }}>
    <div className={cn('relative bg-fill-two overflow-hidden h-[400px] bg-cover bg-center bg-no-repeat', className)}   style={{ backgroundImage: `url('${visibleBanner?.image}' || '/app-thumbnail.png'})` }}>
       {/* <Image
